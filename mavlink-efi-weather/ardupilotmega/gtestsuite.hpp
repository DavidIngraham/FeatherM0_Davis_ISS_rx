...
TEST(ardupilotmega, WEATHER)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::WEATHER packet_in{};
    packet_in.wind = 151;
    packet_in.wind_dir = 17443;
    packet_in.temperature = -38;
    packet_in.raw_press = 963497464;
    packet_in.relative_humidity = 29;
    packet_in.rain_rate = 96;

    mavlink::ardupilotmega::msg::WEATHER packet1{};
    mavlink::ardupilotmega::msg::WEATHER packet2{};
    ...
    EXPECT_EQ(packet1.wind, packet2.wind);
    EXPECT_EQ(packet1.wind_dir, packet2.wind_dir);
    EXPECT_EQ(packet1.temperature, packet2.temperature);
    EXPECT_EQ(packet1.raw_press, packet2.raw_press);
    EXPECT_EQ(packet1.relative_humidity, packet2.relative_humidity);
    EXPECT_EQ(packet1.rain_rate, packet2.rain_rate);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, WEATHER)
{
    mavlink_message_t msg;
    ...
    mavlink_weather_t packet_c {
         963497464, 17443, 151, -38, 29, 96
    };
    ...
    mavlink_msg_weather_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.wind, packet2.wind);
    EXPECT_EQ(packet_in.wind_dir, packet2.wind_dir);
    EXPECT_EQ(packet_in.temperature, packet2.temperature);
    EXPECT_EQ(packet_in.raw_press, packet2.raw_press);
    EXPECT_EQ(packet_in.relative_humidity, packet2.relative_humidity);
    EXPECT_EQ(packet_in.rain_rate, packet2.rain_rate);
